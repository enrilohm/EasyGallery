...
class ObjectBrowseFragment : Fragment() {
    ...
    private fun loadObjectGrid() {
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            objectItems = withContext(Dispatchers.IO) {
                ...
                ObjectsStore.getDistinctObjectLabels().mapNotNull { (label, _) ->
                    val paths = viewModel.applyFilters(ObjectsStore.getImagePathsByLabel(label))
    ...
    private fun showImagesForLabel(label: String) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            val rawPaths = withContext(Dispatchers.IO) { ObjectsStore.getImagePathsByLabel(label) }
